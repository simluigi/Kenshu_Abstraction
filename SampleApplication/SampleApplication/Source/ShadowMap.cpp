...
void ShadowMap::Render(RenderContext& renderContext, RenderingData& renderingData)
{
...
bool ShadowMap::Create(RenderContext& renderContext, RenderingData& renderingData)
{
...
void ShadowMap::Terminate(RenderContext& renderContext)
{
	renderContext.Terminate();
}

bool ShadowMap::CreateRenderingPipeline(RenderingData& renderingData)
{
...
bool ShadowMap::CreateBox(RenderingData& renderingData)
{
...
bool ShadowMap::CreatePlane(RenderingData& renderingData)
{
	std::vector<MeshVertex> vertices =
	{
...
bool ShadowMap::CreateBoxTexture(RenderingData& renderingData)
{
...
bool ShadowMap::CreatePlaneTexture(RenderingData& renderingData)
{
	constexpr int TEXTURE_SIZE = 256;
	constexpr int PIXEL_DATA_SIZE = 4;
