...
void MeshDraw::Render(RenderContext& renderContext, RenderingData& renderingData)
{
    m_input->Update();
...
bool MeshDraw::Create(RenderContext& renderContext, RenderingData& renderingData)
{
...
void MeshDraw::Terminate(RenderContext& renderContext)
{
    renderContext.Terminate();
}

bool MeshDraw::CreateRenderingPipeline(RenderingData& renderingData)
{
...
void MeshDraw::UpdateCamera(RenderingData& renderingData, const char* cameraName)
{
